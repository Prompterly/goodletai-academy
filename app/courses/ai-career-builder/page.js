    ...
    <div style={{ minHeight: '100vh', fontFamily: 'Arial, sans-serif' }}>
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '30px' }}>
          ...
          <a href="/courses" style={{ color: '#f5576c', textDecoration: 'none', fontWeight: 'bold' }}>Courses</a>
      ...
      <header style={{
        ...
        <h1 style={{ fontSize: '3rem', marginBottom: '20px', fontWeight: 'bold' }}>AI Career Builder</h1>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '20px 20px 0' }}>
        <a href="/courses/ai-career-builder/progress" style={{
          ...
          <span style={{ color: '#f5576c', fontWeight: 'bold', fontSize: '1.2rem' }}>→</span>
        </a>
      </div>
