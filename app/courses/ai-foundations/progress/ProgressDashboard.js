...
const allBadges = [
  {
    ...
    emoji: '🧠',
    description: 'You understand the basic principles behind modern artificial intelligence.',
    earnedAfter: 3
  },
  {
    name: 'Prompt Engineer',
    emoji: '⚡',
    description: 'You can write structured prompts that guide AI systems toward useful outputs.',
    earnedAfter: 5
  },
  {
    name: 'AI Productivity Builder',
    emoji: '🚀',
    description: 'You know how to use AI tools to improve productivity and complete tasks efficiently.',
    earnedAfter: 7
  },
  {
    name: 'AI Workflow Designer',
    emoji: '🎓',
    description: 'You can design workflows that combine AI tools and human judgment.',
    earnedAfter: 10
  }
]
    ...
    <div style={{ minHeight: '100vh', fontFamily: 'Arial, sans-serif', background: '#f8fafc' }}>
      ...
      <header style={{
        ...
        <h1 style={{ fontSize: '2.2rem', marginBottom: '10px', fontWeight: 'bold' }}>
          Your AI Foundations Progress
        </h1>
        <p style={{ opacity: 0.85, fontSize: '1.1rem' }}>
          Track your journey from AI-curious to AI-proficient
        </p>
      </header>
      ...
      <main style={{ maxWidth: '900px', margin: '0 auto', padding: '50px 20px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: '140px',
            borderRadius: '50%',
            background: `conic-gradient(#667eea ${progressPercent * 3.6}deg, #edf2f7 0deg)`,
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            margin: '0 auto 25px'
            ...
            <div style={{
              ...
              <span style={{ fontSize: '2.2rem', fontWeight: '800', color: '#667eea' }}>
                {progressPercent}%
              </span>
            </div>
          </div>
          ...
          {nextLesson && (
            <a
              href={`/courses/ai-foundations/${nextLesson.slug.current}`}
              style={{
